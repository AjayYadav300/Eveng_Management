...
public final class bookHis_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    </head>\n");
      out.write("    <body>\n");
      out.write("    <center><h2>Booking History</h2></center>\n");
      out.write("        \n");
      ...
      out.write("            <th>CVV/CVC</th>\n");
      out.write("        </tr>\n");
      out.write("    </thead>\n");
      out.write("        ");

            BookImpl udo=new BookImpl(DBConnect.getConn());
           int id=(int)session.getAttribute("userobj");
           List<BookingDtls>li=new ArrayList<BookingDtls>();
           if(id==1){
           li=udo.admin();
           }
           else{
      ...
      out.write("</td>\n");
      out.write("            <td>");
      out.print(u.getpName());
      out.write("</td>\n");
      out.write("            <td>");
      out.print(u.getcNumber());
      out.write("</td>\n");
      out.write("           <td>");
      out.print(u.getExpiry());
      out.write("</td>\n");
      out.write("           <td>");
      out.print(u.getCvv());
      out.write("</td>\n");
